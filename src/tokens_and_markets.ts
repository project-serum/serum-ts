...
export const TOKEN_MINTS: Array<{ address: PublicKey; name: string }> = [
  ...
  {
    address: new PublicKey('GUohe4DJUA5FKPWo3joiPgsB7yzer7LpDmt1Vhzy3Zht'),
    name: 'KEEP',
  },
  {
...
export const MARKETS: Array<{
  ...
  {
    name: 'KEEP/USDT',
    address: new PublicKey('6N3oU7ALvn2RPwdpYVzPBgQJ8njT29inBbS2tSrwx8fh'),
    programId: new PublicKey('EUqojwWA2rd19FZrzeBncJsm38Jm1hEhE3zsmX3bRc2o'),
    deprecated: false,
  },
  {
  ...
  {
    name: 'MATH/USDT',
    address: new PublicKey('5P6dJbyKySFXMYNWiEcNQu8xPRYsehYzCeVpae9Ueqrg'),
    programId: new PublicKey('EUqojwWA2rd19FZrzeBncJsm38Jm1hEhE3zsmX3bRc2o'),
    deprecated: false,
  },
  {
